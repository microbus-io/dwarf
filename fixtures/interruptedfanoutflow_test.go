...
func TestInterruptedfanoutflow(t *testing.T) {
	...
	graph := workflow.NewGraph("interruptedfanoutflow.verify:428/interrupted-fan-out")
	...
	proxy.HandleTask("interruptedfanoutflow.verify:428/src", func(ctx context.Context, f *workflow.Flow, metadata map[string]any) error {
		return nil
	})
	proxy.HandleTask("interruptedfanoutflow.verify:428/a", func(ctx context.Context, f *workflow.Flow, metadata map[string]any) error {
		f.SetInt("executed", 1)
		return nil
	})
	proxy.HandleTask("interruptedfanoutflow.verify:428/b", func(ctx context.Context, f *workflow.Flow, metadata map[string]any) error {
	...
	proxy.HandleTask("interruptedfanoutflow.verify:428/c", func(ctx context.Context, f *workflow.Flow, metadata map[string]any) error {
		f.SetInt("executed", 1)
		return nil
	})
	proxy.HandleTask("interruptedfanoutflow.verify:428/j", func(ctx context.Context, f *workflow.Flow, metadata map[string]any) error {
