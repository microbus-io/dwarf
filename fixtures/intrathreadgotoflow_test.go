...
func TestIntrathreadgotoflow(t *testing.T) {
	...
	proxy.HandleTask("intrathreadgotoflow.verify:428/task-a", func(ctx context.Context, f *workflow.Flow, baggage any) error {
		return nil
	})
	proxy.HandleTask("intrathreadgotoflow.verify:428/loop-task", func(ctx context.Context, f *workflow.Flow, baggage any) error {
	...
	proxy.HandleTask("intrathreadgotoflow.verify:428/normal-c", func(ctx context.Context, f *workflow.Flow, baggage any) error {
		f.SetString("stamp", "stamped")
		return nil
	})
	proxy.HandleTask("intrathreadgotoflow.verify:428/task-d", func(ctx context.Context, f *workflow.Flow, baggage any) error {
