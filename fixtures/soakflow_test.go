...
func TestSoakflow(t *testing.T) {
	...
	soakGraph := workflow.NewGraph("Soak")
	soakGraph.SetEndpoint("Seed", "soakflow.verify:428/seed")
	soakGraph.SetEndpoint("FanA", "soakflow.verify:428/fan-a")
	soakGraph.SetEndpoint("Work", "soakflow.verify:428/work")
	soakGraph.SetEndpoint("Collect", "soakflow.verify:428/collect")
	soakGraph.SetEndpoint("Loop", "soakflow.verify:428/loop")
	soakGraph.SetEndpoint("Sub", "soakflow.verify:428/sub")
	soakGraph.SetEndpoint("BoomR", "soakflow.verify:428/boom-r")
	soakGraph.SetEndpoint("Recover", "soakflow.verify:428/recover")
	soakGraph.SetEndpoint("BoomF", "soakflow.verify:428/boom-f")
	soakGraph.SetEndpoint("Join", "soakflow.verify:428/join")
	...
	soakGraph.AddTransitionChain("Work", "Collect", "Join")
	...
	soakGraph.AddTransitionChain("BoomF", "Join", workflow.END)
	proxy.HandleGraph("soakflow.verify:428/soak", soakGraph)

	innerGraph := workflow.NewGraph("Inner")
	innerGraph.SetEndpoint("InnerEntry", "soakflow.verify:428/inner-entry")
