...
func TestFanoutflow(t *testing.T) {
	...
	proxy.HandleTask("fanoutflow.verify:428/task-a", func(ctx context.Context, f *workflow.Flow, metadata map[string]any) error {
		f.SetBool("markA", true)
		return nil
	})
	proxy.HandleTask("fanoutflow.verify:428/task-b", func(ctx context.Context, f *workflow.Flow, metadata map[string]any) error {
		f.SetBool("markB", f.GetBool("markA"))
		return nil
	})
	proxy.HandleTask("fanoutflow.verify:428/task-c", func(ctx context.Context, f *workflow.Flow, metadata map[string]any) error {
		f.SetBool("markC", f.GetBool("markA"))
		return nil
	})
	proxy.HandleTask("fanoutflow.verify:428/task-d", func(ctx context.Context, f *workflow.Flow, metadata map[string]any) error {
		f.SetBool("markD", f.GetBool("markA"))
		return nil
	})
	proxy.HandleTask("fanoutflow.verify:428/task-e", func(ctx context.Context, f *workflow.Flow, metadata map[string]any) error {
