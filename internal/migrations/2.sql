...
CREATE TABLE IF NOT EXISTS dwarf_steps (
    ...
    state_refs        JSON         NOT NULL DEFAULT ('{}'),
    ...
    cohort_arrived    TINYINT      NOT NULL DEFAULT 0,
    cohort_resolved   TINYINT      NOT NULL DEFAULT 0,
    ...
    INDEX idx_dwarf_steps_selection (status, parked, priority, fairness_key, created_at, step_id),
...
CREATE TABLE IF NOT EXISTS dwarf_steps (
    ...
    cohort_arrivals   INT              NOT NULL DEFAULT 0,
    cohort_failures   INT              NOT NULL DEFAULT 0,
    cohort_arrived    SMALLINT         NOT NULL DEFAULT 0,
    cohort_resolved   SMALLINT         NOT NULL DEFAULT 0,
    fan_out_ordinal   INT              NOT NULL DEFAULT 0,
    predecessor_id    BIGINT           NOT NULL DEFAULT 0,
    successor_id      BIGINT           NOT NULL DEFAULT 0,
    priority          INT              NOT NULL DEFAULT 5,
...
-- DRIVER: pgx
CREATE INDEX idx_dwarf_steps_selection ON dwarf_steps (status, parked, priority, fairness_key, created_at, step_id) WHERE status IN ('pending', 'running');
...
CREATE TABLE dwarf_steps (
    ...
    state             VARBINARY(MAX) NOT NULL DEFAULT 0x7B7D,
    changes           VARBINARY(MAX) NOT NULL DEFAULT 0x7B7D,
    interrupt_payload VARBINARY(MAX) NOT NULL DEFAULT 0x7B7D,
    state_refs        VARBINARY(MAX) NOT NULL DEFAULT 0x7B7D,
    ...
    interrupt_done    TINYINT       NOT NULL DEFAULT 0,
    resume_data       VARBINARY(MAX) NOT NULL DEFAULT 0x7B7D,
    subgraph_done     TINYINT       NOT NULL DEFAULT 0,
    subgraph_result   VARBINARY(MAX) NOT NULL DEFAULT 0x7B7D,
...
CREATE TABLE IF NOT EXISTS dwarf_steps (
    ...
    cohort_arrived    INTEGER  NOT NULL DEFAULT 0,
    cohort_resolved   INTEGER  NOT NULL DEFAULT 0,
